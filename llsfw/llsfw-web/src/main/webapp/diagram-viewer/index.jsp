...
$(document).ready(function(){
  ...
  ActivitiRest.options = {
    processInstanceHighLightsUrl: basePath + "/service/process-instance/{processInstanceId}/highlights?callback=?",
    processDefinitionUrl: basePath + "/service/process-definition/{processDefinitionId}/diagram-layout?callback=?",
    processDefinitionByKeyUrl: basePath + "/service/process-definition/{processDefinitionKey}/diagram-layout?callback=?"
  };
